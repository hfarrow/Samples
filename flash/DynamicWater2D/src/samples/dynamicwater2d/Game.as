package samples.dynamicwater2d 
{
	...
	public class Game extends QuadraSample
	{
		...
		private function initWater():void
		{
			...
			waterShape.fluidProperties.viscosity = 6;
			//waterShape.fluidProperties.gravity = new Vec2(0, 100);
			...
			_water.addComponent(new SpatialComponent(stage.stageWidth / 2, stage.stageHeight - stage.stageHeight / 4));
			_water.addComponent(new VelocityComponent());
			_water.addComponent(new NapePhysicsComponent(waterBody));
			_water.addComponent(new StarlingDisplayComponent(new WaterBodyDisplay(_water), -1, true));
			_water.refresh();
		}
